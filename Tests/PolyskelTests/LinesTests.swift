...
class LinesTests: XCTestCase {
    ...
    func testLineSegmentMidpoint() {
        let l = LineSegment(start: Vector(0, 0, 0), end: Vector(10, 0, 0))!
...
class LineSegmentsTests: XCTestCase {
    ...
    func testLineSegmentIntersectionXY() {
        let l1 = LineSegment(start: Vector(-1, 0, 3), end: Vector(2, 0, 3))!
        let l2 = LineSegment(start: Vector(0, 1, 3), end: Vector(0, 0, 3))!
    ...
    func testLineSegmentIntersectionXZ() {
        let l1 = LineSegment(start: Vector(-1, 3, 0), end: Vector(2, 3, 0))!
        let l2 = LineSegment(start: Vector(0, 3, 1), end: Vector(0, 3, 0))!
    ...
    func testLineSegmentIntersectionYZ() {
        let l1 = LineSegment(start: Vector(3, -1, 0), end: Vector(3, 2, 0))!
        let l2 = LineSegment(start: Vector(3, 0, 1), end: Vector(3, 0, 0))!
